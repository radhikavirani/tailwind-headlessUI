...
import MainImage from './../../../assets/img/DistributionFirstSection.png'
import MainImage2 from './../../../assets/img/DistributionFirstSection2.png'
        ...
        <div>
            ...
            <div className="container mx-auto sm:pt-[76px] pt-[85px] sm:pb-[145px] pb-[102.62px] lg:flex grid lg:justify-between justify-center items-center sm:px-5 px-4">
                <div className='relative lg:order-1 order-2'>
                    <div className='sm:mb-[21px] mb-1 sm:mt-0 mt-[45px] flex sm:ml-0 ml-5'>
                       <BgDesign/>
                    </div>
                    <h1 className='sm:text-left text-center sm:text-[44px] text-2xl Inter_500 xl:w-[667px] lg:w-[470px] w-auto sm:mb-6 mb-3 sm:leading-[56px] leading-[32px]'>Distribution Lorem ipsum <br/> dolor sit amet,
                    </h1>
                ...
                <div className='relative lg:order-2 order-1 lg:mb-0 sm:mb-16 mb-0'>
                    ...
                    <div className="sm:h-[51px] h-[30px] sm:w-[51px] w-[30px] rounded-full bg-primary absolute sm:right-0 right-2 sm:bottom-0 bottom-[-35px]"></div>
                    <div className="sm:h-[131px] h-[110px] sm:w-[131px] w-[110px] border border-secondary rounded-full flex justify-center items-center absolute sm:top-[-55px] top-[-20px] lg:left-[-55px] sm:left-[-20px] left-0 z-[-1]">
